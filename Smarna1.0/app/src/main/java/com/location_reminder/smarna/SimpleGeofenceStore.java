...
import static com.location_reminder.smarna.Constants.INVALID_FLOAT_VALUE;
import static com.location_reminder.smarna.Constants.INVALID_INT_VALUE;
import static com.location_reminder.smarna.Constants.INVALID_LONG_VALUE;
import static com.location_reminder.smarna.Constants.KEY_EXPIRATION_DURATION;
import static com.location_reminder.smarna.Constants.KEY_LATITUDE;
import static com.location_reminder.smarna.Constants.KEY_LONGITUDE;
import static com.location_reminder.smarna.Constants.KEY_PREFIX;
import static com.location_reminder.smarna.Constants.KEY_RADIUS;
import static com.location_reminder.smarna.Constants.KEY_TRANSITION_TYPE;
/**
...
public class SimpleGeofenceStore {
     ...
     */
    public MyPlaces getGeofence(String id) {
        ...
        if (lat != INVALID_FLOAT_VALUE
            ...
            return new MyPlaces(id, lat, lng, radius, expirationDuration);
        }
     ...
     */
    public void setGeofence(String id, MyPlaces geofence) {
        ...
        prefs.putFloat(getGeofenceFieldKey(id, KEY_RADIUS), geofence.getFenceRadius());
